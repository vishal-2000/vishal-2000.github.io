...
function isGetServerData(node) {
  var _node$declaration, _node$declaration$id, _node$declaration2;

  // check for
  // export function getServerData() {}
  // export async function getServerData() {}
  if (((_node$declaration = node.declaration) === null || _node$declaration === void 0 ? void 0 : _node$declaration.type) === `FunctionDeclaration` && ((_node$declaration$id = node.declaration.id) === null || _node$declaration$id === void 0 ? void 0 : _node$declaration$id.name) === `getServerData`) {
    return true;
  } // check for
  ...
  if (((_node$declaration2 = node.declaration) === null || _node$declaration2 === void 0 ? void 0 : _node$declaration2.type) === `VariableDeclaration`) {
    for (const declaration of node.declaration.declarations) {
      if (declaration.type === `VariableDeclarator` && declaration.id.type === `Identifier` && declaration.id.name === `getServerData`) {
        return true;
      }
    }
  }
